...
const workItems: WorkItem[] = [
    ...
    { id: 2, title: 'Lunora', category: 'work.categories.lunora', image: '/portfolio/lunora-DigitiNexus.webp', alt: 'Sito web di Lunora, operatore di hospitality balneare in Versilia, realizzato da DigitiNexus', url: 'https://lunora.srl' },
    { id: 3, title: 'Aste Balneari', category: 'work.categories.astebalneari', image: '/portfolio/astebalneari-DigitiNexus.webp', alt: 'Sito web di Aste Balneari, società di consulenza per concessioni demaniali, realizzato da DigitiNexus', url: 'https://astebalneari.it' },
