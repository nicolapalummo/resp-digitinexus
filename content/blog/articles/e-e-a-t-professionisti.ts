...
const article: Article = {
  id: 31,
  title: 'E-E-A-T per professionisti: trasmettere autorità online',
  metaTitle: 'E-E-A-T per professionisti: autorità online | DigitiNexus',
  slug: 'e-e-a-t-professionisti',
  metaDescription:
    'Come uno studio professionale dimostra esperienza e affidabilità online: firma autore, credenziali, casi e segnali di fiducia per Google e AI.',
  capsule:
  ...
  keywordPrimary: 'autorevolezza online professionista',
  keywordsSecondary: ['e-e-a-t professionisti', 'fiducia sito professionista'],
  cluster: 'c4',
  isPillar: false,
  intent: 'I·MOFU',
  ...
  faq: [
    {
      q: 'L\'iscrizione all\'albo è davvero un segnale di fiducia?',
      a: 'Sì, è uno dei più forti, perché è una credenziale esterna e verificabile, non un\'autodichiarazione. Indicarla con chiarezza (foro, ordine, numero) rafforza l\'E-E-A-T per Google e per le AI, e rassicura il visitatore. Per un avvocato, un commercialista o un architetto è la prova più immediata di competenza riconosciuta.',
    },
    {
      q: 'Serve davvero firmare gli articoli del sito?',
      a: 'Sì. La firma collega il contenuto a una persona reale con credenziali, e questo è il cuore della "author authority" che Google e le AI valutano. Un articolo anonimo trasmette molta meno fiducia di uno scritto e firmato da un professionista identificabile, con bio, foto reale e iscrizione all\'albo visibili.',
    },
    {
      q: 'Le recensioni contano per l\'E-E-A-T?',
      a: 'Molto. Sono il segnale di autorevolezza più accessibile: un riconoscimento esterno che conferma la tua affidabilità. Per uno studio, dove la scelta è una questione di fiducia, le recensioni autentiche pesano più della pubblicità. Vanno raccolte con metodo e gestite bene, comprese quelle critiche, mai inventate.',
    },
    {
      q: 'Come collego tra loro i miei profili professionali?',
      a: 'Con la proprietà sameAs nel Person schema, che dichiara alle AI quali account ufficiali appartengono alla stessa persona (sito, LinkedIn, scheda Google, registri professionali). L\'importante è la coerenza: stesso nome, stesso studio e stesse credenziali ovunque, così l\'AI ricostruisce un\'identità solida e affidabile.',
    },
  ],
  internalLinks: [
    { slug: 'sito-web-studio-professionale', anchor: 'Sito web per uno studio professionale' },
    { slug: 'e-e-a-t-author-authority', anchor: 'E-E-A-T, autore e author authority' },
