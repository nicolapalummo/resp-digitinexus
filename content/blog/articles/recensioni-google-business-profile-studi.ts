...
const article: Article = {
  id: 34,
  title: 'Recensioni e Google Business Profile per studi professionali',
  metaTitle: 'Recensioni e Google Business Profile per studi | DigitiNexus',
  slug: 'recensioni-google-business-profile-studi',
  metaDescription:
    'Come usare Google Business Profile e le recensioni per far crescere uno studio professionale nella ricerca locale e nelle risposte AI.',
  capsule:
  ...
  keywordPrimary: 'recensioni studio professionale',
  keywordsSecondary: ['google business profile studio', 'scheda google avvocato'],
  cluster: 'c4',
  isPillar: false,
  intent: 'I·C·MOFU',
  ...
  body: [
    ...
    {
      type: 'cta',
      text: 'Vuoi una scheda Google e un sito che lavorano insieme per farti trovare in zona e dalle AI? Costruiamo presenze digitali coerenti per studi professionali.',
      label: 'Parliamone',
  ...
  faq: [
    {
      q: 'Un professionista può chiedere recensioni ai clienti?',
      a: 'In genere sì, se le recensioni sono reali e spontanee e non offri nulla in cambio. Valgono però i vincoli deontologici della tua professione e il segreto professionale: la comunicazione deve restare veritiera e non suggestiva. Verifica le regole specifiche con l\'ordine o il collegio di appartenenza.',
    },
    {
      q: 'Come gestisco una recensione negativa?',
      a: 'Rispondi con calma e tono professionale, senza entrare nel merito della pratica e senza rivelare alcun dettaglio. Ringrazia per il riscontro e invita a un confronto in privato. Se la recensione è falsa o offensiva puoi segnalarla a Google, ma intanto una risposta sobria protegge la tua immagine.',
    },
    {
      q: 'Google Business Profile è gratis?',
      a: 'Sì, creare e gestire una scheda Google Business Profile è gratuito. Ti permette di comparire su Ricerca e Maps con orari, contatti, foto e recensioni. Il valore non sta nel costo ma nella cura: una scheda completa, coerente con il sito e aggiornata viene mostrata più spesso e trasmette più fiducia.',
    },
    {
      q: 'Le recensioni aiutano a comparire nelle risposte delle AI?',
      a: 'Sì, indirettamente. Le AI generative ricostruiscono la reputazione di uno studio dai segnali pubblici, e una scheda completa con recensioni autentiche e dati coerenti è uno di questi. Non garantisce di essere citati, ma rende lo studio più riconoscibile e affidabile sia per Google sia per gli assistenti AI.',
    },
  ],
  internalLinks: [
    { slug: 'sito-web-studio-professionale', anchor: 'Il sito web per uno studio professionale' },
    { slug: 'farsi-trovare-ai-professionista', anchor: 'Farsi trovare con le AI come professionista' },
    { slug: 'local-seo', anchor: 'Posizionarsi nella ricerca locale' },
  ],
  sources: [],
};
